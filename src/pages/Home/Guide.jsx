...
const Guide = () => {
  return (
    <div className="bg-[#0F0E12] text-white text-sm h-auto pt-[50px] pb-10   ">
      <div className=" container mx-auto px-4 sm:px-8 md:px-12 lg:px-16 xl:px-0 xl:max-w-[75rem]   ">
        <div className="relative w-full h-auto bg-no-repeat bg-center  bg-[url('./assets/guid.png')]">
          <div className="flex justify-center items-center py-[29px] bg-gradient-to-t from-[#111224] via-[#070610]/90 to-[#070610] xl:rounded-xl ">
            <h3 className="guide-title text-lg lg:text-[24px]">
              All Set Guide list
            </h3>
          </div>
        </div>

        <div className="flex justify-between items-start gap-5 flex-col flex-wrap xl:flex-nowrap xl:flex-row sm:flex-row mt-4">
          <div className=" sm:w-full xl:w-1/2 tft-meta  ">
            <h4 className="tft-meta-title text-lg">TFT Meta Comps in Set 12</h4>
          ...
          <div className="sm:w-full xl:w-1/2 game-bordcontiner ">
